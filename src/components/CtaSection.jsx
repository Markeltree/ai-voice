        ...
        <div className="cta-card">
          <div className="grid md:grid-cols-2 gap-6 md:gap-10 w-full relative z-10 p-6 sm:p-10 md:p-16">
            <div className="text-white space-y-4 md:space-y-6">
              ...
              Launch your own AI voice agent development company today, without building anything from scratch. We handle the technology; you own the client relationship.
              </p>
